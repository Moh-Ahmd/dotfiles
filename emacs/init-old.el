...
(custom-set-variables
 ...
 '(package-selected-packages
   '(visual-fill-column org-bullets forge evil-magit magit projectile hydra evil-collection evil general kanagawa-themes which-key rainbow-delimiters ivy-rich helpful gruvbox-theme doom-themes doom-modeline counsel command-log-mode all-the-icons)))
(custom-set-faces
